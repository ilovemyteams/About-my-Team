                        ...
                        description: [
                            {
                                ...
                                text: "Ми не просто створюємо сайти, а робимо їх унікальними інструментами для вашого бізнесу, можете переглянути вже виконані нами проєкти в *link=`/${locale}/#portfolio` noblank*портфоліо*/link*",
                            },
                            {
