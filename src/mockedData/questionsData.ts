        ...
        ua: {
            ...
            fullAnswerContent: [
                ...
                },
                {
                    ...
                    text: "Щоб створити дійсно корисний бриф, важливо не просто «написати анкету», а зрозуміти бізнес, продукт і очікування замовника. Збирати дані можна двома шляхами: усно (під час інтерв’ю чи зустрічі) та письмово (анкета або документ).",
                ...
                },
                {
                    ...
                    text: "Щоб бриф справді працював, важливо не лише «дати замовнику документ», а правильно організувати процес. Ми зібрали головні поради з нашої практики, які допомагають зберегти фокус, економлять час і зменшують кількість правок.",

                    data: [
                        {
                            title: "Почати з живої розмови",
                            text: [
                        ...
                        {
                            title: "Спочатку збір, потім фіксація",
                            text: [
