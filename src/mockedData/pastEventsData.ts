...
export const pastEventsData: PastEventsData = [
    {
        ...
        ua: {
            ...
            description: [
                ...
                "У розіграші, що відбувся 21 квітня, переможцем став Микола Калакуцький! Вітаємо щасливчика та дякуємо всім за участь!",
            ],
            date: "20.04.2025",
        },
        pl: {
            ...
            description: [
                ...
                `W losowaniu, które odbyło się 21 kwietnia, zwycięzcą został Mykola Kalakutskyi! Gratulujemy szczęśliwemu i dziękujemy wszystkim za udział!`,
            ],
            date: "20.04.2025",
        },
        en: {
            ...
            description: [
                ...
                `The prize draw took place on April 21, and the lucky winner was Mykola Kalakutskyi! Congratulations to the winner, and a big thank you to everyone who took part!`,
            ],
            date: "20.04.2025",
        },
    },
