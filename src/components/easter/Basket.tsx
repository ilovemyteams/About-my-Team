...
export const Basket = () => {
    return (
        <Link
            href="/events"
            className=" relative w-8 tab:w-10 desk:w-[50px] h-[50px] tab:h-[60px] desk:h-[76px] flex justify-center"
        >
            <Image
            ...
            <motion.div
                ...
                className="w-5 tab:w-6 desk:w-8 h-auto absolute bottom-1 tab:bottom-[10px] desk:bottom-4"
                style={{
