...
export const PolicyContent = () => {
    ...
    return (
        <PageSection className="pb-[32px] tab:pb-[40px] pc:pb-[100px] desk:pb-[120px]">
            <h1 className="font-caviar font-bold text-purple-200 dark:text-grey text-3xl mb-9 tab:text-4xl tab:mb-[60px] pc:text-6xlt pc:mb-[72px] desk:text-7xl desk:mb-[80px]">
