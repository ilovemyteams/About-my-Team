            ...
            <ul className="tab:flex tab:flex-wrap tab:justify-center">
                {chronologyData &&
                    chronologyData.map((data, index) => (
                        <li
                            key={index}
                            className="h-[360px] border border-b-0 last:border-b tab:border-b tab:border-r-0 tab:even:border-r-1 tab:last:border-r-1 tab:border-t-0 tab:first:border-t-1 tab:[&:nth-child(2)]:border-t  px-4 pb-6 pt-3 flex flex-col justify-between  dark:border-purple-stroke border-purple-strokeLight tab:w-[50%]"
                        >
