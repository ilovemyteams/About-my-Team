...
import { wishesData, WishProp } from "@/src/mockedData/wishesData";
...
export const SecondScene = () => {
    ...
    const [shuffledWishes, setShuffledWishes] = useState<WishProp[]>([]);

    useEffect(() => {
        setShuffledWishes(shuffleArray(wishesData));
    }, []);
        ...
        <PageSection className="pt-3 pb-11 tab:pb-[100px] desk:pb-[140px]">
            ...
            >
                ...
                <Balloon
                    ...
                    randomWishId={
                        shuffledWishes[0]?.id ? shuffledWishes[0].id : ""
                    }
                    id="pinkBalloon"
                ...
                <Balloon
                    heartPNG="/images/valen/pinkBalloon.png"
                    randomWishId={
                        shuffledWishes[1]?.id ? shuffledWishes[1].id : ""
                    }
                    id="pinkBalloon"
                ...
                <Balloon
                    ...
                    randomWishId={
                        shuffledWishes[2]?.id ? shuffledWishes[2].id : ""
                    }
                    id="pinkBalloon"
                ...
                <Balloon
                    heartPNG="/images/valen/redBalloon.png"
                    randomWishId={
                        shuffledWishes[3]?.id ? shuffledWishes[3].id : ""
                    }
                    id="pinkBalloon"
                ...
                <Balloon
                    ...
                    randomWishId={
                        shuffledWishes[4]?.id ? shuffledWishes[4].id : ""
                    }
                    id="pinkBalloon"
                ...
                <Balloon
                    heartPNG="/images/valen/magentaBalloon.png"
                    randomWishId={
                        shuffledWishes[5]?.id ? shuffledWishes[5].id : ""
                    }
                    id="pinkBalloon"
                ...
                <Balloon
                    heartPNG="/images/valen/magentaBalloon.png"
                    randomWishId={
                        shuffledWishes[6]?.id ? shuffledWishes[6].id : ""
                    }
                    id="pinkBalloon"
                ...
                <Balloon
                    ...
                    randomWishId={
                        shuffledWishes[7]?.id ? shuffledWishes[7].id : ""
                    }
                    id="pinkBalloon"
                ...
                <Balloon
                    heartPNG="/images/valen/purpleBalloon.png"
                    randomWishId={
                        shuffledWishes[8]?.id ? shuffledWishes[8].id : ""
                    }
                    id="pinkBalloon"
                ...
                <Balloon
                    heartPNG="/images/valen/purpleBalloon.png"
                    randomWishId={
                        shuffledWishes[9]?.id ? shuffledWishes[9].id : ""
                    }
                    id="pinkBalloon"
