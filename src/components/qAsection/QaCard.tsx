...
export const FaqCard = ({ data, localizationData }: FaqCardItemProps) => {
        ...
        <div className="container">
            <div className="flex flex-col tab:flex-row py-4 tab:gap-3 border-b-1 border-purple-stroke">
                ...
                <div className="flex flex-col justify-between">
                    ...
                    <div className="flex justify-between">
                        <p className="text-purple-50">{readTime} хв читати</p>
                        {/* Here should be a Link instead of button */}
                        <button
