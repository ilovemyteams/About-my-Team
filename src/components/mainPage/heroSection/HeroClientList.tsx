...
export const HeroClientList = () => {
    ...
    return (
        <div className="px-2">
            <h3 className="font-caviar font-bold text-xl desk:text-2xl dark:text-white-100 text-purple-200 mb-3 desk:mb-2">
            ...
            <ul className="flex flex-col gap-2">
                {clientList.map((item, index) => (
                    <li
                        key={index}
                        className="text-purple-200 dark:text-grey text-base desk:text-xl py-[5px] desk:py-[2.5px] flex gap-[10px] items-center"
                    >
