...
export const PortfolioSlider = () => {
    ...
    return (
        <div
            className="embla overflow-hidden w-portfolioHeroCard tab:w-[50%] tab:min-w-[360px] max-w-[540px] flex flex-col-reverse mt-[34px]
          tab:flex-col tab:items-end 
          deskxl:w-[668px] deskxl:max-w-[668px] tab:mt-[27px]"
        >
            ...
            <div
                className="mb-4 tab:mb-0 tab:w-[100%] pc:mb-0 max-w-[540px] tab:min-w-[360px] pc:min-w-[540px] overflow-hidden deskxl:w-[668px]  deskxl:max-w-[668px] "
                ref={emblaRef}
            >
