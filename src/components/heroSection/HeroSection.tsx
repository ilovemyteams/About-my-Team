...
export const HeroSection = () => {
    return (
        <Section className="pt-8 tab:pt-[100px] pc:pt-8">
            ...
            <div className="absolute top-[100px] tab:top-[101px] pc:top-[60px] desk:top-[77px] left-[7%] tab:left-[13%] pc:left-[12.5%] desk:left-[7.5%] w-[29px] tab:w-[46px] pc:w-[36px] desk:w-[75px] rotate-[-32deg] pc:rotate-[-23deg]">
                <IconEnvelopeCheap />
            </div>
