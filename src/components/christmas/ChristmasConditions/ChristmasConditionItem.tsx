...
import { LayoutSubtitle } from "../../servicePage/shared/LayoutSubtitle";
import { LayoutText } from "../../servicePage/shared/LayoutText";
import { Lines } from "../../servicePage/TwoSideListWithLines/Lines";

interface ChristmasConditionItemProps {
    content: DescriptionType;
}
export const ChristmasConditionItem = ({
    content,
}: ChristmasConditionItemProps) => {
