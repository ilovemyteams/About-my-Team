...
const textAreaStyles =
    "block appearance-none w-full h-[80px] mt-[20px] pr-[5px] bg-transparent outline-none font-caviar text-baseb placeholder-purple-strokeFormLebelLight dark:placeholder-purple-strokeFormLebel text-base transition-color duration-300 ease-out scroll";
const errorStyles =
