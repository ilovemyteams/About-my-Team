...
export const LinkGoBack = ({
    ...
    return (
        <Link
            href={linkBack}
            className={`bg-transparent h-12 min-w-12 justify-center items-center focus:outline-none px-0 inline-flex gap-2 font-caviar text-sm  tab:text-lg dark:pc:hover:text-red pc:hover:text-redLight
        ...
        >
            <IconGoBack />
            <p className="border-b border-current">
