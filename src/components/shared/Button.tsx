...
export const Button = ({ children, color = "red", className }: ButtonProps) => {
    return (
        <button
            className={`group ${color === "red" ? redColor : greyColor} relative w-[288px] min-h-[48px] h-[48px] pc:w-[270px] pc:h-[56px] font-caviar text-xlb pc:text-2xl border-solid border-y-[1px]
            pc:hover:after:transition-opacity pc:hover:after:duration-200 pc:hover:after:ease-out pc:hover:before:transition-opacity pc:hover:before:duration-200 pc:hover:before:ease-out after:content-[''] after:absolute after:bottom-[2px] 
             after:left-0 after:h-[0.8px] after:w-full after:opacity-0 before:content-[''] before:absolute before:bottom-[4px] before:left-0 before:h-[1px] before:w-full
