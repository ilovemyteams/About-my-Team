    ...
    return (
        ...
        >
            ...
            <input
                ...
                className={`flex-grow h-[44px] text-purple-200 dark:text-grey placeholder:text-greyLight dark:placeholder:text-grey focus:placeholder:text-purple-strokeFormLabel dark:focus:placeholder:text-purple-strokeFormLabel focus:outline-none bg-transparent`}
            />
