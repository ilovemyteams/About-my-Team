...
export const CookiesComponent = () => {
    ...
    return (
        <div
            ref={cookiesRef}
            className={`${isAccepted ? "h-0 " : "h-[292px] tab:h-[212px] pc:h-[171px] "} w-full transition-[height] duration-[2000ms] dark:bg-CTAGradient bg-CTAGradientLight  overflow-hidden linear  fixed z-[11]  bottom-0 left-0 flex  pc:pl-[80px] deskxl:pl-[120px]`}
        >
