...
export const OfertaContent = () => {
    ...
    const { data, title, description, definitions } = ofertaData;
    ...
    return (
        <PageSection className="pb-[32px] tab:pb-[40px] pc:pb-[100px] desk:pb-[120px] text-sm20 text-balance tab:text-pretty tab:text-base23 pc:text-xl28 desk:text-2xl">
            ...
            <div className=" mb-8 tab:mb-10 pc:mb-[100px] desk:mb-[120px]">
                <h3 className="font-caviar font-bold text-2xl tab:text-3xl28 text-purple-200 whitespace-pre-wrap dark:text-white-200 pc:text-4xl desk:text-6xlt mb-4 tab:min-h-[auto] tab:mb-6 pc:mb-10 desk:mb-[64px]">
                    {definitions.title}
                </h3>
                <ul className="flex flex-col gap-4 pb-4 border-b-[1px] border-purple-strokeLight dark:border-purple-stroke tab:pb-6 pc:pb-10 desk:pb-[64px]">
