...
import { OneSliderCases } from "./OneSliderCases";
...
export const MoreCasesSliderTab = ({
    projects,
}: {
        ...
        <div className="relative embla min-w-full ">
            <div className=" overflow-hidden" ref={emblaRef}>
                <ul className="flex gap-0 ">
                    <OneSliderCases projects={projects} />
                </ul>
            </div>
            <div className="embla__controls  tab:absolute tab:-top-[90px] pc:-top-[112px] right-0 mt-[16px] tab:mt-0">
