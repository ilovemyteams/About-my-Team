...
export const BurgerMenuButton = ({
    ...
    return (
        <button
            ...
            className="relative w-12 h-12 p-[7.2px] pc:p-1 flex justify-center items-center icon-hover-rounded-purple icon-hover-rounded-purple:hover icon-hover-rounded-purple:focus-visible icon-hover-rounded-purple:focus-within"
        >
