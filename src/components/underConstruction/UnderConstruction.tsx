...
export const UnderConstruction = () => {
    ...
    return (
        <div className="relative bg-[url('/images/under-construction.jpg')] bg-no-repeat bg-cover bg-center z-10 before:content-[''] before:absolute before:inset-0 before:bg-underConstructionGradientLight before:dark:bg-underConstructionGradient before:z-[-5]">
