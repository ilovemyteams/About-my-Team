...
import {aboutUsHomeSectionType, aboutUsItemType} from './objects/module/aboutUsHomeType'
...
const annotations: ObjectDefinition[] = [linkEmailType, linkExternalType, linkInternalType]
...
const blocks: ArrayDefinition[] = [portableTextType, portableTextSimpleType, portableColorTitleType]
...
export const schema: {types: SchemaTypeDefinition[]} = {
  types: [...documents, ...annotations, ...singletons, ...blocks, ...objects, ...arrays],
}
